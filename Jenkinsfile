    ...
    stages
    {
        ...
        stage ("Push Image To DockerHub")
        {
            steps{
                ...
                sh 'docker tag myimage:v1.$BUILD_ID yakkhub4881/myimage:v1.$BUILD_ID'
                sh 'docker tag myimage:v1.$BUILD_ID yakkhub4881/myimage:latest'
                sh 'docker push yakkhub4881/myimage:v1.$BUILD_ID'
                sh 'docker push yakkhub4881/myimage:latest'
                 }
            }
        }
